...
**Version:** 2.7.0
**Tools registered on the server:** 229
**Tools indexed for keyword discovery:** 169 in 15 categories
...
These are the categories `search_tools` searches. They cover 169 of the 229 registered tools.
